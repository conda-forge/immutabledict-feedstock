...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/immutabledict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10703&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/immutabledict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `immutabledict` can be installed with:

```
conda install immutabledict
```

It is possible to list all of the versions of `immutabledict` available on your platform with:
